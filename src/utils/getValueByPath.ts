export function getValueByPath<RD = any, Data = any>({
  data,
  path,
  separator = '.',
...
//
// function getValueByPath<RD = any, Data extends FieldValues = any, EntityPath extends Path<Data> = any>({
//                                                                                                          data,
//                                                                                                          path,
//                                                                                                          separator = '.',
//                                                                                                          returnDataType = 'string',
...
//   separator?: '.' | '/' | '_' | '-' | '*' | '+';
//   returnDataType?: 'string' | 'number' | 'object';
// }): RD | PathValue<Data, EntityPath> | null {
//   if (!data || !path) {
//     return null;
//   }
//   const keys = path.split(separator);
