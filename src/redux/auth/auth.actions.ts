...
import { onPermissionLogoutMatch } from '../permissions/permissions.action';
...
export function onUserLogoutMatch(a: Action) {
  return (
    isAnyOf(LogOutUserAction, logOutUserThunk.fulfilled, logOutUserThunk.rejected)(a) || onPermissionLogoutMatch(a)
  );
}
