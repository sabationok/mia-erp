...
const PageCompanies = lazy(() => import('./PageCompanies'));
...
export { AppGridPage, PageNotFound, PageError, PageTransactions, PageCompanies, PageSelectCompany, PageHome, PageAuth };
